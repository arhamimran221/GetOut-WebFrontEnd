  ...
  return (
    <div className='fixed top-0 left-0 right-0 bg-[#fff] z-[9999] ' style={{boxShadow:'0px 4px 4px 0px #00000026'}}>
      <div className="flex justify-between items-end px-4 w-[100%] container py-[20px]">
        ...
        <div className="flex gap-[20px] w-[30%] justify-center">
          <button className='px-4 py-2 border-[1px] border-[#ff0000] bg-[#ff0000] font-poppins text-[#fff] leading-[16px] text-[16px] font-[400] rounded-md' onClick={()=>navigate('/login')}>Create an event</button>
