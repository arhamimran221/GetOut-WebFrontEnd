    ...
    <div className='fixed top-0 left-0 right-0 bg-[#fff] z-[9999] border-b-[3px] border-b-[#F5F5F5]' >
      <div className="flex justify-between items-end px-4 w-[100%] container py-[20px]">
        <div className="flex gap-[50px] items-center w-[30%] justify-start pb-[5px] ml-[15px]">
          ...
          ?
          <><Link to="/host-protocol" className={location.pathname.includes("/host-protocol")  ? 'font-poppins text-[#ff0000] leading-[16px] text-[16px] font-[500]' : 'font-poppins text-[#000] leading-[16px] text-[16px] font-[500] hover:text-[#ff0000] ease-in-out duration-300'}>
            Host Protocol
          </Link>
          </> :
        ...
        <div className="flex gap-[20px] w-[30%] justify-end">
          <button className='px-4 py-2 border-[1px] border-[#ff0000] bg-[#ff0000] font-poppins text-[#fff] leading-[16px] text-[16px] font-[400] rounded-md' onClick={()=>navigate('/host-protocol/create-event')}>Create an event</button>
          {!location.pathname.includes("/host-protocol") &&
            <button className='px-4 py-2 border-[1px] border-[#828282]  font-poppins text-[#828282] leading-[16px] text-[16px] font-[400] rounded-md' onClick={()=>navigate('/')}>Sign in</button>}
        </div>
      </div>
    </div>
  )
