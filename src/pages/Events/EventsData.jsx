...
const EventsData = (props) => {
  return (
    <div className='w-[300px] h-[67px] flex border-[2px] border-[#F5F5F5] overflow-hidden rounded-lg  items-center relative'>
      <div className="w-[21%]">
      ...
      <div className="absolute right-[10px] top-[7px] text-[#828282]">
